...
register(id='Fanuc_pivoting-v2', entry_point='impedance_envs.envs.Fanuc_pivoting_v2:Fanuc_pivoting')
register(id='Fanuc_pivoting_easy-v0', entry_point='impedance_envs.envs.Fanuc_pivoting_easy_setup:Fanuc_pivoting')
register(id='Fanuc_door-v0', entry_point='impedance_envs.envs.Fanuc_door:Fanuc_pivoting')
